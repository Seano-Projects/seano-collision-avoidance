...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "thruster_adapter_preview_node = seano_vision.thruster_adapter_preview_node:main",
            "guarded_thruster_test_adapter_node = seano_vision.guarded_thruster_test_adapter_node:main",
            "thruster_test_safety_guardian_node = seano_vision.thruster_test_safety_guardian_node:main",
            "thruster_test_hud_node = seano_vision.thruster_test_hud_node:main",
            "auto_takeover_manager_node = seano_vision.auto_takeover_manager_node:main",
            "auto_takeover_hud_node = seano_vision.auto_takeover_hud_node:main",
        ],
    },
)
